...
@endif
      <div class="col-xs-6 text-left">
          <h3>FICHA DE CALIFICACIÓN INDIVIDUAL</h3>
          ...
          <div class="col-xs-12">
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <h5><u>JUICIO SINTÉTICO:</u> {{ $calificado->juicio_sintetico }} </h5>
...
<div class="container">
  <pre>NOTIFCACION DE LA CALIFICACION:</pre>

      <div class="row">
          <div class="col-xs-12">
              <div class="panel panel-default">
                  <div class="panel-body">
                    <h5><u>FECHA DE NOTIFICACIÓN:</u> _________________________________ </h5></br>
                    <h5><u>REVISTA:</u> ______________________________________________ </h5></br>
                    <h5><u>JERARQUIA:</u> ___________________________________________ </h5></br>
                    <h5><u>APELLIDO:</u> _____________________________________________ </h5></br>
                    <h5><u>NOMBRES:</u> _____________________________________________ </h5></br>
                    <h5><u>FIRMA:</u> ________________________________________________ </h5></br>
                  </div>
              </div>
          </div>
      </div>
