...
//pdf
    ...
    //Visualizar
        public function visualizar()
        {
          ...
          $calificaciones_realizadas = Calificacion::where('estado', 0)
                            ...
                            ->get();
           return view('admin.calificador.visualizar')->with(compact('calificaciones_realizadas'));
        }
    ...
    //Aprobar
        public function aprobar()
        {
          ...
          $calificaciones_realizadas = Calificacion::where('aprobado', 0)
                            ->where('revista_calificador', auth()->user()->revista)
                            ->get();
           return view('admin.calificador.aprobar')->with(compact('calificaciones_realizadas'));
        }
    ...
    //Notificar
        public function notificar()
        {
          ...
          $calificaciones_realizadas = Calificacion::where('notificado', 0)
                            ->where('revista_calificador', auth()->user()->revista)
                            ->get();
           return view('admin.calificador.notificar')->with(compact('calificaciones_realizadas'));
        }
    ...
    //HOME
        ...
        {
          $usuario_revista = Auth::user()->revista;

          $a = Calificacion::where('estado', 0)->where('revista_calificador', auth()->user()->revista);

          $calificaciones_realizadas = DB::table('calificaciones_informes')
                                          ->whereRevista_calificador($usuario_revista)
                                          ->whereEstado(0)
                                          ->count();
          ...
          $calificaciones_sin_notificar = DB::table('calificaciones_informes')
           ...
           return view('admin.calificador.home')->with(compact('calificaciones_realizadas', 'calificaciones_sin_aprobar', 'calificaciones_sin_notificar' ));
        }
